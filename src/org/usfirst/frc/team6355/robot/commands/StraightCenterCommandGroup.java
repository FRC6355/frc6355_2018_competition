 ...
 * 
 */
public class StraightCenterCommandGroup extends CommandGroup {
    
    private static final double AUTONOMOUS_DRIVE_FORWARD_INCHES_1 = 48.0;
    private static final double AUTONOMOUS_DRIVE_FORWARD_INCHES_2 = 108.0;
    ...
    private static final double AUTONOMOUS_DRIVE_FORWARD_INCHES_3 = 84.0;


    
    public StraightCenterCommandGroup() {
...
//    	System.out.println("turn forward.");
    	this.addSequential(new TurnSecondsCommand(AUTONOMOUS_TURN_SECONDS, AUTONOMOUS_TURN_VALUE_1)); // left 180
